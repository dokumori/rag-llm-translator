...
Provides:
  ...
  - generate_litellm_config()  : derive config/litellm/config.yaml from models.yaml
...
def generate_litellm_config(models_yaml_path: str, output_path: str) -> None:
    ...
    header = (
        ...
        f"# Auto-generated from config/models.yaml on {datetime.now():%Y-%m-%d %H:%M}\n"
        f"# Do NOT edit this file directly — edit config/models.yaml instead.\n"
