            ...
            if [ -n "$LITELLM_CONFIG" ]; then
                {
                    ...
                    echo "  # Silently drop provider-unsupported params (e.g. temperature for o-series models)"
                    echo "  # instead of propagating a 400 error to the caller."
...
OLLAMA_ENTRY
            ...
            if [ "$GENERATE_CUSTOM_MODELS" = true ]; then
                ...
                python3 bin/lib/model_config.py generate \
