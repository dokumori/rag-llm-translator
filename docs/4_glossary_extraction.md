...
* **Variation Detection:** Specifically flags English terms that have multiple Japanese translations, showing the "Primary" choice versus "Alternatives."
...
| **Target** | The most frequent Japanese translation (the "Winner"). | `ブラウザ` |
...
| **Alternatives** | Other translations found, with their specific occurrence counts. | `ブラウザー (5); 閲覧ソフト (1)` |
